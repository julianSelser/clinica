    ...
    class ConectorSQL
    {
        ...
        private static void _ejecutarProcedure(string procedure, List<string> args, params object[] values)
        {
            ...
            try
            {
                ...
                cm.CommandText = "CUATRO_QUESOS." + procedure;
        ...
        private static List<string> _generateArguments(string procedure)
        {
            ...
            try
            {
                ...
                cm.CommandText = "SELECT PARAMETER_NAME FROM information_schema.parameters WHERE SPECIFIC_SCHEMA='CUATRO_QUESOS' AND SPECIFIC_NAME='" + procedure + "'";
                dr = cm.ExecuteReader();
                dt.Load(dr);
